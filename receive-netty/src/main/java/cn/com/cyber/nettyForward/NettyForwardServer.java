 ...
 * 移动信息网转发服务，未使用 . <br>
 */
public class NettyForwardServer implements Runnable {

    /**
     * 日志
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(NettyForwardServer.class);
            ...
            serverBootstrap.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .childHandler(new ChannelInitializer<Channel>() {
                        ...
                        protected void initChannel(Channel ch) {
                            ...
                            ch.pipeline().addLast(new NettyForwardHandler());
                        }
                    });
